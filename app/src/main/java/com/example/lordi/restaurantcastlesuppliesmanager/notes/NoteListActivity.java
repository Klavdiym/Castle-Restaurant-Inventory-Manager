...
import com.example.lordi.restaurantcastlesuppliesmanager.notes.data.Note;
import com.example.lordi.restaurantcastlesuppliesmanager.notes.data.NoteViewHolder;
import com.example.lordi.restaurantcastlesuppliesmanager.notes.data.NotesContentContract;
import com.example.lordi.restaurantcastlesuppliesmanager.views.CatalogActivity;
        ...
        implements LoaderManager.LoaderCallbacks<Cursor>
{
    ...
    FloatingActionButton backToCatalogButton;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        backToCatalogButton = findViewById(R.id.backToCatalog);
        backToCatalogButton.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent openCatalogActivity = new Intent(NoteListActivity.this, CatalogActivity.class);
                startActivity(openCatalogActivity);
            }
        });
